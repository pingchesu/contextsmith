...
export default function AdminPage() {
  ...
  return <main className="page"><PageHeader eyebrow="Admin" title="Operations and observability" description="Platform operations surface for provider health, indexing status, freshness risk, and audit events. This is no longer a blank placeholder." />
