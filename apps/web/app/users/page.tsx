...
export default function UsersPage() {
  ...
  return <main className="page"><PageHeader eyebrow="User Management" title="Users, roles, and token permissions" description="Workspace/project permission visibility. Users should not need UUIDs to understand who can review, configure, or query generated agents." />
