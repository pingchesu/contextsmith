...
| Self-improvement product surface | PR #206 / `6babf67` | Local Docker Compose stack, session login, project-scoped API, web console | 2026-06-30 | Self-improvement `/self-improvement` -> MVP smoke -> redacted review history/artifact detail -> sleep dry-run | Covered by `make qa-smoke` API proof and product docs; visual recapture remains a launch-signoff follow-up if this page becomes part of public screenshots. |
