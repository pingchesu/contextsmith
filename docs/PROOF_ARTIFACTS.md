...
| Self-improvement product surface: overview, no-silent-mutation boundary, MVP smoke, redacted review history/artifact detail, and sleep dry-run. | [`docs/evaluations/self-improvement-browser-20260630/README.md`](evaluations/self-improvement-browser-20260630/README.md); PR #206 / `6babf67`; `make qa-smoke`; `tests/unit/test_self_improvement_mvp_product.py`. CORS proof-stack setup finding tracked as #231. |
